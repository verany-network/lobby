...
import net.verany.hubsystem.game.hubswitcher.HubSwitcherInventory;
import net.verany.hubsystem.game.inventory.TeleporterInventory;
...
@Getter
@Setter
public class HubPlayer extends DatabaseLoader implements IHubPlayer {
